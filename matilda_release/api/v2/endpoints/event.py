...
from matilda_release.api.v2.model.model import event
from matilda_release.api.v2.handler import event_handler
from matilda_release.api.v2.model.model import  release_link_items
...
class EventCollection(Resource):
    ...
    @api.marshal_list_with(event, skip_none=True)
    def get(self):
        """
        Returns list of releases.
        """
        resp = event_handler.get_events()
        return resp
    ...
    def post(self):
        ...
        event_handler.post_events(data)
        return None, 201
